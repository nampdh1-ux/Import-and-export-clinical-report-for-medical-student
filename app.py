...
# --- CSS BỐ CỤC BỔ SUNG, DÙNG THEME MẶC ĐỊNH CỦA STREAMLIT ---
st.markdown("""
<style>
    /* ==============================================================================
    ...
    *:focus, *:focus-visible {
    ...
    /* Trả các widget về giao diện mặc định của Streamlit, giữ nguyên bố cục app. */
    div[data-testid="stExpander"],
    div[data-testid="stExpander"] > details > summary,
    div[data-testid="stTextInput"] > div,
    div[data-testid="stTextArea"] > div,
    ...
    *:focus-visible {
    ...
    /* Giữ các khối HTML tùy biến nhưng bỏ màu sắc, font và hiệu ứng Y2K. */
    .sidebar-header-amboss,
    .sub-section-header,
    .highlight-dx,
    .overview-panel,
