...
<style>
    ...
    *:focus, *:focus-visible {
    ...
    /* ==============================================================================
       9. NÚT RADIO & PHÔNG CHỮ TIÊU ĐỀ (ĐÃ SỬA LỖI CHỮ ARROW)
       ============================================================================== */
    
    /* Ép phông chữ Tahoma cho chữ thường, nhưng CHỪA LẠI các biểu tượng icon của hệ thống */
    .stApp h1, .stApp h2, .stApp h3, .stApp p, .stApp label, 
    .stApp span:not(.material-symbols-rounded):not([class*="icon"]):not([class*="Icon"]) {
        font-family: 'Tahoma', 'Segoe UI', sans-serif !important;
    }

    /* Đảm bảo mũi tên expander và các icon trả về đúng phông vẽ hình */
    ...
    /* Vòng tròn Radio button: Lún 3D Win2K */
